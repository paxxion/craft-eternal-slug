...
namespace paxxion\crafteternalslug\elements;
...
class UrlHistoryElement extends BaseUiElement
{
    ...
    {
        return Craft::t('eternal-slug', 'Url History');
    }
    ...
    public function formHtml(?ElementInterface $element = null, bool $static = false): ?string
    {
        ...
        return Craft::$app->getView()->renderTemplate('eternal-slug/cp/elements/urlHistory', [
            'rows' => $rows,
        ]);
    }
